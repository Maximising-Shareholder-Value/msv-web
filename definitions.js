...
const DEFINITIONS = {
  ...
  interestCoverage: {
    what: "Interest Coverage Ratio: how many times over the company's annual operating profit could pay its annual interest expense on its debt.",
    formula: "Interest Coverage = Operating Income (EBIT) ÷ Interest Expense",
    high: "A high ratio means interest payments are easily covered by operating profit — plenty of cushion even if profits dip.",
    low: "A low ratio (roughly under 2-3x) means interest payments eat up most of operating profit, leaving little room for a bad year before debt becomes a real strain.",
    sector: "Capital-intensive, steady-cash-flow sectors like utilities and REITs can comfortably run lower coverage (their revenue is very predictable). Cyclical sectors (energy, industrials) generally want more cushion since their operating profit can swing hard from year to year.",
  },
  ltDebtToEquity: {
    what: "Long-Term Debt-to-Equity: long-term debt (borrowing due in more than a year) divided by shareholder equity — a narrower cut of leverage than total Debt-to-Equity, since it excludes short-term/current debt.",
    formula: "LT D/E = Long-Term Debt ÷ Shareholder Equity",
    high: "More reliance on long-term borrowing relative to the company's own capital — can be efficient financing if the debt is cheap and locked in for a long time, but adds fixed obligations regardless of how business performs.",
    low: "Little long-term debt outstanding — conservative financing, though possibly missing out on cheap, long-dated borrowing to fund growth.",
    sector: "Utilities and REITs routinely carry high long-term debt against steady, regulated/contracted cash flows. Tech companies typically carry much less, since they rely less on physical assets to borrow against.",
  },
  payoutRatio: {
    what: "Dividend Payout Ratio: the share of net income paid out to shareholders as dividends, rather than kept and reinvested in the business.",
    formula: "Payout Ratio = Dividends Paid ÷ Net Income",
    high: "A high payout ratio (much above 60-70%, or over 100%) means the company is returning most or all of its profit to shareholders, leaving little for reinvestment — over 100% means it's paying out more than it earned, which isn't sustainable indefinitely.",
    low: "A low or 0% payout ratio means the company is reinvesting most/all of its profit back into the business rather than paying it out.",
    sector: "Mature, slow-growth sectors like utilities and consumer staples often run payout ratios of 60–80%. Growth-stage tech companies often run near 0%, reinvesting everything instead.",
  },
  assetTurnover: {
    what: "Asset Turnover: total revenue divided by total assets. Measures how efficiently a company uses everything it owns to generate sales.",
    formula: "Asset Turnover = Revenue ÷ Total Assets",
    high: "A high asset turnover means the company generates a lot of sales relative to what it owns — common for asset-light or high-volume businesses like retail.",
    low: "A low asset turnover means it takes a large asset base to generate each dollar of sales — typical of capital-intensive businesses like utilities or telecom, not automatically inefficient.",
    sector: "Retail and grocery chains often run high asset turnover (2x+) since they sell through inventory quickly on a relatively small asset base. Utilities and telecom often run well under 1x, since they require enormous infrastructure investment relative to revenue.",
  },
  inventoryTurnover: {
    what: "Inventory Turnover: how many times a company sells through its entire inventory over a year.",
    formula: "Inventory Turnover = Cost of Goods Sold ÷ Average Inventory",
    high: "A high turnover means inventory moves fast — generally efficient, though extremely high turnover can also mean the company is under-stocking and risking missed sales.",
    low: "A low turnover means goods sit in inventory longer before selling — can tie up cash and risk obsolescence, though it's normal for some product categories.",
    sector: "Grocery and fast fashion retailers often turn inventory 8–12+ times a year. Industrial equipment or luxury goods makers often turn much slower (2-4x) simply because of what they sell and how long it takes to move — not inherently a problem.",
  },
  receivablesTurnover: {
    what: "Receivables Turnover: how many times a year a company collects its average accounts receivable (money customers owe it) — a measure of how quickly it gets paid.",
    formula: "Receivables Turnover = Revenue ÷ Average Accounts Receivable",
    high: "A high turnover means customers pay quickly — good for cash flow, less money tied up waiting to be collected.",
    low: "A low turnover means customers take longer to pay, or the company offers generous credit terms — ties up more cash in the meantime and carries more collection risk.",
    sector: "Consumer-facing businesses that get paid at the point of sale (retail, restaurants) often show very high turnover. B2B businesses that invoice large corporate/government customers on 60-90 day terms often run much lower, as a normal part of how that industry does business.",
  },
  roe: {
  ...
  roa: {
    what: "Return on Assets (ROA): net income divided by total assets. Shows how efficiently a company turns everything it owns — cash, inventory, equipment, everything — into profit, regardless of how that's financed (debt vs. equity).",
    formula: "ROA = Net Income ÷ Total Assets",
    high: "A high ROA means the company squeezes a lot of profit out of what it owns — efficient, asset-light businesses like software tend to score well here.",
    low: "A low ROA is typical of asset-heavy businesses (airlines, utilities, manufacturers) that need a huge base of equipment/infrastructure to generate each dollar of profit — not automatically a red flag, just a structural difference.",
    sector: "Asset-light sectors like software often post ROA of 10–20%+. Capital-intensive sectors like airlines, telecom, or utilities often run ROA in the low single digits even when healthy, simply because of how much physical infrastructure sits on the balance sheet.",
  },
  roi: {
    what: "Return on Investment (ROI): a broad measure of how much profit the company generates relative to the total capital invested in it (roughly, debt plus equity).",
    formula: "ROI = Net Income ÷ Total Invested Capital",
    high: "A high ROI suggests the company is generating strong returns on the capital — borrowed and shareholders' own — that's been put into the business.",
    low: "A low ROI suggests the business isn't generating much return relative to the capital tied up in it, worth comparing against the company's own cost of capital.",
    sector: "Like ROE and ROA, typical ROI ranges vary a lot by how capital-intensive the sector is — expect it to run higher at software/services companies and lower at heavy industry, utilities, or telecom.",
  },
  epsTTM: {
  ...
  priceToSales: {
    what: "Price-to-Sales (P/S) Ratio: compares the stock price to the company's revenue per share — useful for valuing companies with little or no profit, where P/E doesn't work.",
    formula: "P/S = Market Cap ÷ Total Revenue (or Share Price ÷ Revenue Per Share)",
    high: "A high P/S means the market is paying a lot for each dollar of current sales, usually reflecting expectations of strong future growth or high margins.",
    low: "A low P/S can mean undervaluation, or reflect a genuinely low-margin business where a dollar of revenue is worth less to investors.",
    sector: "High-margin software companies can command P/S of 8-15x+ since each dollar of revenue converts to a lot of profit. Low-margin sectors like retail or grocery are often valued closer to 0.5-1.5x sales.",
  },
  priceToCashFlow: {
    what: "Price-to-Cash-Flow (P/CF) Ratio: compares the stock price to the company's operating cash flow per share — cash actually generated by the business, which is harder to manipulate with accounting choices than reported earnings.",
    formula: "P/CF = Market Cap ÷ Operating Cash Flow (or Share Price ÷ Cash Flow Per Share)",
    high: "A high P/CF means investors are paying a premium for each dollar of cash the business actually generates, usually pricing in future growth.",
    low: "A low P/CF can suggest undervaluation relative to the cash the business throws off, or reflect market skepticism about that cash flow continuing.",
    sector: "Typical ranges track P/E fairly closely sector-to-sector — capital-light, high-margin businesses (software) tend to run higher P/CF than capital-intensive ones (industrials, retail).",
  },
  revenueGrowth: {
